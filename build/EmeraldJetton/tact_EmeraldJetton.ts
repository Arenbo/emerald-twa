...
export type EmeraldJetton$Data = {
    $$type: 'EmeraldJetton$Data';
    total_supply: bigint;
    owner: Address;
    content: Cell;
    mintable: boolean;
...
export function storeEmeraldJetton$Data(src: EmeraldJetton$Data) {
    return (builder: Builder) => {
        let b_0 = builder;
...
export function loadEmeraldJetton$Data(slice: Slice) {
    let sc_0 = slice;
    ...
    return { $$type: 'EmeraldJetton$Data' as const, total_supply: _total_supply, owner: _owner, content: _content, mintable: _mintable, max_supply: _max_supply };
}

function loadTupleEmeraldJetton$Data(source: TupleReader) {
...
function loadGetterTupleEmeraldJetton$Data(source: TupleReader) {
    let _total_supply = source.readBigNumber();
    let _owner = source.readAddress();
    let _content = source.readCell();
    let _mintable = source.readBoolean();
...
function storeTupleEmeraldJetton$Data(source: EmeraldJetton$Data) {
    let builder = new TupleBuilder();
...
function dictValueParserEmeraldJetton$Data(): DictionaryValue<EmeraldJetton$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeEmeraldJetton$Data(src)).endCell());
        },
        parse: (src) => {
            return loadEmeraldJetton$Data(src.loadRef().beginParse());
        }
    }
}
...
function initEmeraldJetton_init_args(src: EmeraldJetton_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeRef(src.content);
...
async function EmeraldJetton_init(owner: Address, content: Cell, max_supply: bigint) {
    ...
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initEmeraldJetton_init_args({ $$type: 'EmeraldJetton_init_args', owner, content, max_supply })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmeraldJetton_errors: { [key: number]: { message: string } } = {
...
const EmeraldJetton_types: ABIType[] = [
...
const EmeraldJetton_getters: ABIGetter[] = [
...
export const EmeraldJetton_getterMapping: { [key: string]: string } = {
    'get_jetton_data': 'getGetJettonData',
    'get_wallet_address': 'getGetWalletAddress',
    'owner': 'getOwner',
}

const EmeraldJetton_receivers: ABIReceiver[] = [
...
export class EmeraldJetton implements Contract {
    
    static async init(owner: Address, content: Cell, max_supply: bigint) {
        return await EmeraldJetton_init(owner, content, max_supply);
    }
    
    static async fromInit(owner: Address, content: Cell, max_supply: bigint) {
        const init = await EmeraldJetton_init(owner, content, max_supply);
        const address = contractAddress(0, init);
        return new EmeraldJetton(address, init);
    }
    
    static fromAddress(address: Address) {
        return new EmeraldJetton(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmeraldJetton_types,
        getters: EmeraldJetton_getters,
        receivers: EmeraldJetton_receivers,
        errors: EmeraldJetton_errors,
    };
